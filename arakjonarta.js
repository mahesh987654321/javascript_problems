...
// } else {
//     console.log("The first number is not less than the second number.");
// }
...
// if (first == second) {
//     console.log("The first number and second number are the same.");
// }
// else {
//     console.log("The first number and second number are not the same.");
// }
...
// } else {
//     console.log("The first number is not less than or equal to the second number.")
// }
...
// }
// else {
//     console.log("The first number is not greater than or equal to the second number.");
// }
...
// let friends = true;
// let girlFriends = false;

// if (friends == true && girlFriends == false) {
//     console.log("You are a good boy!!!");
// }
// else {
//     console.log("Your future is dark.");
// }

// if (friends == true || girlFriends == false) {
//     console.log("You are a good boy.");
// } else {
//     console.log("Mone hoile pore lekhbo ha ha ha ('_')");
// }
...
// let oldFriends = ['habul', 'kabul', 'dabul', 'naimul', 'haimul', 'jaimul', 'paimul'];

// let oldFriendsLength = oldFriends.length;
// console.log(oldFriendsLength);
// oldFriends[4] = 'Rumon';
// console.log(oldFriends);

// oldFriends.push("Rakib", "Sakib");
// oldFriends.pop();
// console.log(oldFriends);

// ৯. তুমি কি একটা ফর লুপ দিয়ে কোন একটা array এর সবগুলা উপাদানকে দেখাতে পারবে। সেটা রেগুলার for লুপ হোক বা for of হোক। হলে সেই স্টাইলে একটা কোড লিখে ফেলো।

// let newFriends = ['habul', 'kabul', 'dabul', 'naimul', 'haimul', 'jaimul', 'paimul'];

// for (const element of newFriends) {
//     console.log(element);
// }

// ১০. তোমাকে যদি বলা হয়। একটা array এর মধ্যে ৮০ এর চাইতে বড় সংখ্যা থাকলে সেগুলাকে console log করে দেখাতে সেটা কি তুমি পারবে? তাহলে তুমি সেই কোড করে ফেলো 

// let newNumbers = [1, 53, 45, 65, 87, 98, 87, 67, 78, 98, 78, 67, 6, 544, 87, 98, 90, 09, 90, 9098];


// for (let i = 0; i < newNumbers.length; i++) {
//     let element = newNumbers[i];
//     if (element > 80) {
//         console.log(element);
//     }
// }
...
// function multuplyNumbers(num1, num2, num3) {
...
// let result = multuplyNumbers(number1, number2, number3);
...
// let inputFeet = 2;
// const inchResult = feetToInch(inputFeet);
...
// let centimeterToMeterResult = centimeterToMeter(200);
// console.log("The result of centimeter to the meter is :-", centimeterToMeterResult);



// 15. আরেকটা ফাংশন লিখবে যেটার নাম লিখবে। যেই ফাংশনের নাম হবে paperRequirements এই ফাংশনের প্যারামিটার হিসেবে তিনটা প্যারামিটার হবে। প্রথম প্যারামিটার হবে তুমি প্রথম বই কত কপি ছাপাতে চাও। সেকেন্ড প্যারামিটার হবে তুমি সেকেন্ড বই কত কপি ছাপাতে চাও। আর থার্ড প্যারামিটার হবে তুমি থার্ড বই কত কপি ছাপাতে চাও। অর্থাৎ কোন বই এর কত কপি ছাপানো হবে সেটাই প্যারামিটার হিসেবে নিবে। 
...
//     let bookTotal1 = first * 100;
//     let bookTotal2 = second * 200;
//     let bookTotal3 = third * 300;
//     let myTotalpaper = bookTotal1 + bookTotal2 + bookTotal3;
//     return myTotalpaper;
// }
...
// console.log("Total papers is:-", totalPaper);
...
// let myFriends = ['joy', 'shuvo', 'mohiuddin', 'prince', 'talukdar', 'js'];
// let largestName = bestFriend(myFriends);
// console.log("largest name is :-", largestName);
// console.log(typeof largestName);



// 17. এইটা একটু ট্রিকি হতে পারে। একটা array এর মধ্যে অনেকগুলা সংখ্যা থাকবে। তোমার কাজ হচ্ছে সংখ্যা গুলা একটার পর একটা করে চেক করা। এবং সংখ্যা গুলা যদি পজিটিভ সংখ্যা হয়। অর্থাৎ শূন্য বা শূন্যের চাইতে বড় হয় তাহলে সেগুলাকে কোন একটা array এর মধ্যে রাখবে। আর যদি নেগেটিভ সংখ্যা হয়। তাহলে লুপটা স্টপ করে দিবে। এবং লুপ বন্ধ করার আগ পর্যন্ত যতগুলা পজিটিভ সংখ্যা পাওয়া গেছে। সেগুলা রিটার্ন করে দিবে।
...
// const positiveResult = positiveNumbers(allNumbers);
