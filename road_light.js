...
if (x == "red") {
  console.log("This is red signal you can go now");
} else if (x == "yellow") {
  console.log("This is yellow signal you have to wait ");
} else if (x == "green") {
  console.log("This is green signal you are free now you can go");
}
